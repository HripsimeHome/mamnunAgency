...
function CookiePolicy() {
  return (
    <section className="container doc wrapperPadding">
      ...
      <h3>The following types of cookies are used on www.mamnunagency.com:</h3>
      <ul>
        <li>
          <strong>Essential cookies:</strong> These cookies are necessary for
          the proper functioning of the website. They enable navigation and the
          use of its features.
        </li>
        <li>
        ...
        <li>
          ...
          to remember user preferences, such as language or region, making it
      ...
      <p>
        Users can manage cookie settings in their web browser. They can block or
        limit the use of cookies through the browser's settings. However, please
        note that blocking cookies may affect the functionality of the website
        and limit access to some of its features.
      </p>
