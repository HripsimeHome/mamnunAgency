...
const offerData = [
...

  {
    ...
    description: "Enhance your language skills with our comprehensive language courses abroad, available in both short and long-term formats! Whether you're looking to boost your proficiency for travel, work, or personal growth, our experienced instructors provide tailored lessons in immersive environments. Join us and unlock new opportunities through language learning in a vibrant international setting!",   
  },

  {
    ...
    description: "We help you enhance your skills and broaden your horizons with our short-term academic programs! These courses allow you to gain new skills, earn certificates, overcome your language barriers and immerse yourself in diverse cultures. Participating in these programs not only enhances your academic profile but also boosts your career prospects",   
  },

  {
    ...
    description: "Enhance your teaching skills with the comprehensive Teacher Training Programs offered by trusted partners. Designed for educators at all levels, our programs cover innovative teaching strategies, classroom management, curriculum development, and technology integration.",   
  },
  ...
  return (    
    <section className={`${styles.educationOffer} wrapperWhite`}>
      <div className="container"> 
        <h2 className="titleBlackh2">We&nbsp;          
          <span className="titlePurpleh2">offer             
          </span>
        </h2>        
            ...
            {offerData.slice(0, 4).map(({ icon, title, description }, index) => (
              <div className={styles.educationOffer__panel} key={index}>
                <div className={styles.educationOffer__titleBlock}>
                  ...
                  <h3 className={styles.educationOffer__title}>
                    {title}
                  </h3>
                </div>
        ...
        {/* <h2 className="titleBlackh2">Application process and       
           <br />   
          <span className="titlePurpleh2">requirements             
          </span>
        </h2>  */}
