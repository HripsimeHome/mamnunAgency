...
const accordionItems = [
  ...
  {
    title:
      "7. What are the advantages of studying in Uzbekistan compared to studying abroad?",
    content:
  ...
  {
    title:
      "8. What is the difference between merit-based and need-based scholarships?",
    content:
