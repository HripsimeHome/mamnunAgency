...
const accordionItems = [
  ...
  {   
    ...
    content: "The application process involves filling out a form, receiving a free consultation, signing an agreement, submitting required documents, and then allowing us to manage the rest of the process while keeping you updated.",
  },
  ...
  {   
    title: "8. What are the advantages of studying in Uzbekistan compared to studying abroad?",
  ...
  {   
    title: "9. What is the difference between merit-based and need-based scholarships?",
    content:
        ...
        <h1 className="titlePrimaryH2">FAQ</h1>
         <>
            <Accordion 
              ...
              className={styles.aboutFAQ__accordionContainer}
            />
          </>       
      </div>
    </section>
