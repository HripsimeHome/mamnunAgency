...
const accordionItems = [
  {
    ...
    content: "Tailored to highlight your skills and experience for your chosen program."
  },
  
  {
    icon: meritBasedIcon,
    title: "Motivational Letter Writing",
    content: "Customized to suit the specific requirements of your program and university."
  },
...

  {
    ...
    content: "Comprehensive insurance options for your travel and study abroad experience."
  },
  ...
  
  {
    ...
    content: "Personalized support to ensure a smooth and comfortable arrival at your final destination."
  } 
]
