    ...
    <section className={`${styles.educationStories} wrapperWhite`}>
      <div className="container"> 
        ...
        <div className={styles.educationStories__slideContainer}>        
          {storyData.map(({ description, image, webpImage, alt, name, title }, index) => ( 
          <div 
            key={index} 
            className={styles.educationStories__slide}
          > 
