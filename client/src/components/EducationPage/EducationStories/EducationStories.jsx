...
const storyData = [
...

  {
    ...
    image: MukhammadBoburImage,
    webpImage: MukhammadBoburWebpImage,
...

  {
    ...
    image: MukhabbatOImage,
    webpImage: MukhabbatOWebpImage,
      ...
      <div>
        ...
        <div className={styles.educationStories__slideContainer}>
          ...
          >
                    ...
                    <div className={styles.educationStories__storyContainer}>
                      <div className={styles.educationStories__storyBLock}>
                        ...
                        <div className={styles.educationStories__storyInfo}>
                          <span
                            className={styles.educationStories__studientName}
                          >
                            {name}
                          </span>
            ...
            <div
              className={`container ${styles.educationStories__sliderNavigation}`}
            >
              <button
                ref={prevButtonRef}
