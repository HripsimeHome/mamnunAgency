...
import { valuesImage, valuesWebpImage } from "../../../assets/images";
...
const HomeBrief = () => {
  ...
  return (
    <section
      ref={ref}
      className={`${styles.homeBrief} wrapperWhite wrapperPadding`}
    >
      <div className="container">
        <div className={styles.homeBrief__content}>
          <TransitionProvider
            inProp={isInView}
            style={TransitionStyleTypes.right}
            className={styles.homeBrief__text1}
          >
            <p className="textMain">
              ...
              stage—from university admissions to visa assistance. In addition
              to our educational services, we specialize in crafting unique
              travel experiences that ensure every journey is memorable and
              enriching.
            </p>
          </TransitionProvider>
          ...
          <TransitionProvider
            ...
            className={styles.homeBrief__imageColumn}
          >
            <ImageWebp
              src={valuesImage}
              srcSet={valuesWebpImage}
              alt="MAMNUN Agency"
              className={styles.homeBrief__briefImg}
            />
            <MainBtn
          ...
          <TransitionProvider
            inProp={isInView}
            style={TransitionStyleTypes.right}
            className={styles.homeBrief__text2}
          >
            <p className="textMain">
              Our commitment to quality and transparency means you can trust us
              to guide you through the process with clarity and confidence. Your
