...
const accordionItems = [
  {
    image: careersWhiteImage,
    webpImage: careersWhiteWebpImage,
    activeImage: careersBlackImage,
    activeWebpImage: careersBlackWebpImage,
  ...
  {
    image: travelTourismWhiteImage,
    webpImage: travelTourismWhitekWebpImage,
    activeImage: travelTourismBlackImage,
    activeWebpImage: travelTourismBlackWebpImage,
